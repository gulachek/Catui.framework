 ...
 * @return YES if this instance's desired version can use the API's version
 */
 ...
 * @return YES if this instance's API version can support the consumer's desired API version
 */
