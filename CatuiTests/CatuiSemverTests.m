...
@interface CatuiSemverTests : XCTestCase

@end

@implementation CatuiSemverTests
...
- (void)testCanUseCompatibleVersion {
...
- (void)testCantUseIncompatibleVersion {
...
- (void)testCanUseCompatibleZeroBasedVersion {
...
- (void)testCantUseIncompatibleZeroBasedVersion {
